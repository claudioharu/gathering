...
def insert_mangas(connection, mangas):
	...
	add_mangas= "INSERT INTO MangaHere_Mangas (name, link, img, rate, visual, genre, pos, author, artist, info, votes, status) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"

	args = (name, link, img, float(rate), int(visual), genre, pos, author, artist, info, int(votes), status)
