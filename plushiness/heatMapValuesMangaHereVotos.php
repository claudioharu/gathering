...
$sql = 'select MangaHere1.categorie as x, MangaHere2.categorie as y , SUM(votes) as value from MangasCategories as MangaHere1, MangasCategories as MangaHere2, MangaHere_Mangas where MangaHere2.site = "mangahere" and MangaHere1.site = "mangahere" and MangaHere1.name = MangaHere2.name and MangaHere1.name = MangaHere_Mangas.name group by x, y';
