...
$sql = 'select MangaFox1.categorie as x, MangaFox2.categorie as y , SUM(visual) as value from MangasCategories as MangaFox1, MangasCategories as MangaFox2, MangaFox_Mangas where MangaFox2.site = "mangafox" and MangaFox1.site = "mangafox" and MangaFox1.name = MangaFox2.name and MangaFox1.name = MangaFox_Mangas.name group by x, y';
